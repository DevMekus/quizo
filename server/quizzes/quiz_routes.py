...
from quizzes.quiz_controller import create_quiz, list_quizzes, get_quiz, delete_quiz, quiz_results,create_result, delete_result
...
quiz_blueprint.route('/result/<result_id>', methods=['DELETE'])(delete_result)
